...
module.exports = {
  ...
  [discord](https://discord.gg/42JBEttH34) | By [flamy](https://discord.gg/42JBEttH34)`);
...
SlashCommand: {
  ...
  Discord Music Bot Version: v${require("../package.json").version}
  [✨ Support Server]{(https://discord.gg/42JBEttH34)}; | By [flamy](https://discord.gg/42JBEttH34)`);
